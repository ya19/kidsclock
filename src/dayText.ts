...
const LOOKUP: [RegExp, string, string][] = [
  ...
  [/\b(lego|bricks?|blocks?|build)/i, '🧱', '#84cc16'],
  [/\b(puzzle|jigsaw)\b/i, '🧩', '#a855f7'],
  [/\b(dress ?up|pretend|doll|figures?)\b/i, '🪆', '#ec4899'],
  [/\b(train|cars?|track)\b/i, '🚂', '#06b6d4'],
  [/\b(play ?time|play|toys?|game)\b/i, '🧸', '#84cc16'],
  [/\b(draw|paint|art|craft|colou?r)\b/i, '🎨', '#a855f7'],
  [/\b(music|sing|piano|dance)\b/i, '🎵', '#a855f7'],
  [/\b(swim|pool)\b/i, '🏊', '#06b6d4'],
  [/\b(dance|dancing|ballet)\b/i, '🕺', '#a855f7'],
  [/\b(karate|judo|martial)\b/i, '🥋', '#f43f5e'],
  [/\b(ball|football|soccer|sport|gym|tennis|basketball)\b/i, '⚽', '#84cc16'],
  [/\b(tv|screen|movie|film|cartoon)\b/i, '🎬', '#94a3b8'],
  [/\b(tidy|clean|chore|help)\b/i, '🧹', '#94a3b8'],
  [/\b(dog|cat|pet|animal)\b/i, '🐕', '#7c5c3e'],
  [/\b(dentist|teeth check)\b/i, '🦷', '#94a3b8'],
  [/\b(doctor|clinic|appointment|checkup)\b/i, '🩺', '#94a3b8'],
  [/\b(shop|shopping|errand|market)\b/i, '🛒', '#94a3b8'],
  [/\b(grandma|grandpa|granny|family|visit)\b/i, '👨‍👩‍👧', '#ec4899'],
  [/\b(quiet|calm|chill|down ?time)\b/i, '🤫', '#a855f7'],
]
